        ...
        <div className="centered-view">
            <div className="centered-container">
                ...
                <div className="form-container">
                    ...
                    <div className="form-group">
                        <label htmlFor="image">Image: (Copy & paste below link or add your link)</label>
                            <p><label htmlFor="image">https://www.pinclipart.com/picdir/big/559-5594866_necktie-drawing-vector-round-avatar-user-icon-png.png</label></p>
                    <input
                        ref={register}
                        type="text"
                        className="form-control"
